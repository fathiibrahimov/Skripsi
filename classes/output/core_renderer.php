...
namespace theme_skripsian\output;

use theme_config;
use context_course;
use moodle_url;
use html_writer;
use theme_skripsian\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function body_attributes($additionalclasses = array()) {
        $hasaccessibilitybar = get_user_preferences('themeskripsiansettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themeskripsiansettings_fonttype', '');
        if ($fonttype) {
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('skripsian_additional_header', 'lib.php');
