    ...
    function(jQuery, Notification, CustomEvents, Modal, ModalRegistry, Ajax) {
        ...
        var AccessibilityModal = function(root) {
            ...
            var request = Ajax.call([{
                methodname: 'theme_skripsian_getthemesettings',
                args: {}
            }]);
        ...
        AccessibilityModal.TYPE = 'theme_skripsian-themesettings_modal';
        ...
        AccessibilityModal.prototype.registerEventListeners = function() {
            ...
            this.getModal().on(CustomEvents.events.activate, SELECTORS.SAVE_BUTTON, function() {
                var request = Ajax.call([{
                    methodname: 'theme_skripsian_savethemesettings',
                    args: {
        ...
        if (!registered) {
            ModalRegistry.register(AccessibilityModal.TYPE, AccessibilityModal, 'theme_skripsian/accessibilitysettings_modal');
            registered = true;
        }
