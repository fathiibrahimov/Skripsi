...
$THEME->name = 'skripsian';
$THEME->sheets = [];
$THEME->editor_sheets = [];
$THEME->editor_scss = ['editor'];
$THEME->usefallback = false;
$THEME->scss = function($theme) {
    return theme_skripsian_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_skripsian_get_extra_scss';
$THEME->prescsscallback = 'theme_skripsian_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_skripsian_get_precompiled_css';
