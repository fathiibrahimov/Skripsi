...
/**
 * A drawer based layout for the skripsian theme.
 *
...
$templatecontext = [
    ...
    'headerbuttons' => \theme_skripsian\util\extras::get_mypublic_headerbuttons($context, $user),
    'editprofileurl' => \theme_skripsian\util\extras::get_mypublic_editprofile_url($user, $courseid),
...
$themesettings = new \theme_skripsian\util\settings();

$templatecontext = array_merge($templatecontext, $themesettings->footer());

echo $OUTPUT->render_from_template('theme_skripsian/mypublic', $templatecontext);
